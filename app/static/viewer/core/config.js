export const cfg = {
  ...
  WINDOW_DECODE_USE_WORKER: true,
  WINDOW_DECODE_WORKER_PATH: '/static/viewer/window_decode_worker.js',
  ...
  get limits() {
    return {
      ...
      WINDOW_DECODE_USE_WORKER: this.WINDOW_DECODE_USE_WORKER,
      WINDOW_DECODE_WORKER_PATH: this.WINDOW_DECODE_WORKER_PATH,
